...
%
%
% Establishment: 04.04.2021 Zhiqing Yang, PGS, RWTH Aachen
% ########################################################################
...
Ctrl.OP_flag = 1;                       % [s] Operation flag: 1: SPS(bidirection)
                                        %                     2: ADCC (bidirection)
                                        %                     3: IADCC (bidirection) 
Ctrl.ICC_flag = 0;                      % [s] ICC mode: 0: without ICC;
                                        %               1: with ICC 
...
Ctrl.td_flag = 1;                       % [s] dead time compensation mode:  1: on;
                                        %                                   0: off;
Ctrl.zcs = 2*Ctrl.td_in*Ctrl.f_sw;      % [] relative forced ZCS space
...
Ctrl.SetOP.p_ref = [Ctrl.Pref,Ctrl.Pref,Ctrl.Pref/2,Ctrl.Pref/2,Ctrl.Pref];
Ctrl.SetOP.v_in_ref = [Ctrl.Vi,Ctrl.Vi,Ctrl.Vi,Ctrl.Vi,Ctrl.Vi];
Ctrl.SetOP.v_out_ref = [Ctrl.Vo,Ctrl.Vo,Ctrl.Vo,Ctrl.Vo,Ctrl.Vo];   
