...
%
% Establishment: 03.04.2020 Zhiqing Yang, PGS, RWTH Aachen    
% ########################################################################
...
ff_cal_param.op = [OP.Vi,OP.Vo,DAB3.Ntr,Ctrl.f_sw,DAB3.L,OP.P_op,OP.r_op,OP.Pn,Ctrl.td_in,Ctrl.td_out,Ctrl.td_flag];
