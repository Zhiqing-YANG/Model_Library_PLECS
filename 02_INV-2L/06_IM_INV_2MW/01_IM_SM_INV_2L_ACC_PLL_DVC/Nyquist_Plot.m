...
[f_int,phs_int] = find_phase_margin_Nyq(e_1,f_swp,n_sample,2);

% case 2
Ctrl.DVC.Kp  = -37;
e_2 = solve_eig(Grid,Inv,Ctrl,f_swp,1);  
[f_int,phs_int] = find_phase_margin_Nyq(e_2,f_swp,n_sample,2);

% case 3
Ctrl.DVC.Kp  = -39;
e_3 = solve_eig(Grid,Inv,Ctrl,f_swp,1); 
[f_int,phs_int] = find_phase_margin_Nyq(e_3,f_swp,n_sample,2);
