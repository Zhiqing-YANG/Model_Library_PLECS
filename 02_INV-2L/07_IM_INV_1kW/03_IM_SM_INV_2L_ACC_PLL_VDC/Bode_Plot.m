...
Ctrl.VDC.Gdd.Kp = 0;
Ctrl.VDC.Gdd.Ki = 0;
[Z_inv_1,Y_inv_1,Z_pcc_1,Y_pcc_1,Z_g_1,Y_g_1] = IM_INV_2L_ACC_PLL_VDC(Grid,Inv,Ctrl,f_swp);
[f_int_1,phs_int_1] = find_intersection_Bode(Z_pcc_1,Z_g_1,f_swp,n_sample,1);
...
Ctrl.VDC.Gqq.Ki = 30;
[Z_inv_2,Y_inv_2,Z_pcc_2,Y_pcc_2,Z_g_2,Y_g_2] = IM_INV_2L_ACC_PLL_VDC(Grid,Inv,Ctrl,f_swp);
[f_int_2,phs_int_2] = find_intersection_Bode(Z_pcc_2,Z_g_2,f_swp,n_sample,1);

% case 3
[Z_inv_3,Y_inv_3,Z_pcc_3,Y_pcc_3,Z_g_3,Y_g_3] = IM_INV_2L_ACC_PLL_VDC(Grid,Inv,Ctrl,f_swp);
[f_int_3,phs_int_3] = find_intersection_Bode(Z_pcc_3,Z_g_3,f_swp,n_sample,1);
...
legend([h_1,h_2,h_3],'{K}_{p}^{ACC} = 10','{K}_{p}^{ACC} = 8','{K}_{p}^{ACC} = 7');
set(gca,'XScale','log')
grid on
box on
