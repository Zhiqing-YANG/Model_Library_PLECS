...
%% Filter Parameters
% dc-link filters
Inv.Filter.C_dc = 4e-3;           % [F] dc-link capacitance
...
Inv.Filter.L2 = 0e-3;             % [H] filter inductance in grid side
Inv.Filter.R2 = 0e-3;             % [Ohm] parasite resistance in L2

%% Operating Point
Inv.OP.V_dc = 0;                  % [V] operating condition dc-link voltage
Inv.OP.I_pv = 0;                  % [A] operating condition pv current
