/*
 * Implementation file for: SM_Coder_FSM_PLL_ACC_DVC/ Three-Phase 2L Grid-Tied  Inverter/LaunchPad
...
const char * const LaunchPad_checksum =
  "395dac15abc408208765c86d73565a8357e673db";
...
void LaunchPad_step()
{
   ...
   *  ADC : 'LaunchPad/ADC C'
   */
  LaunchPad_B.Saturation = 100.*(HAL_getAnalogInF(1, 0));
  if (LaunchPad_B.Saturation > 250.) {
    LaunchPad_B.Saturation = 250.;
   ...
   *  ADC : 'LaunchPad/ADC A'
   */
  LaunchPad_B.Fcn = ((((HAL_getAnalogInF(2, 0)) - 0.) / 0.709999999999999964) -
                     0.) / 0.00300000000000000006;

  /* Sum : 'LaunchPad/Controller/Direct-Voltage Control/Sum1' */
  LaunchPad_B.Sum1 = LaunchPad_B.Saturation - LaunchPad_B.Fcn;
  ...
  if (LaunchPad_X.Integrator_1_x > 20.) {
    LaunchPad_X.Integrator_1_x = 20.;
  } else if (LaunchPad_X.Integrator_1_x < -20.) {
    LaunchPad_X.Integrator_1_x = -20.;
  }
   ...
   *  ADC : 'LaunchPad/ADC B'
   */
  LaunchPad_B.Fcn_1 = ((((HAL_getAnalogInF(0, 1)) - -0.00700000000000000015) /
  ...
  LaunchPad_B.abc_d = 0.66666666666666663 * (((LaunchPad_B.Fcn_1 *
  ...
  LaunchPad_B.Sum = ((-0.800000000000000044*LaunchPad_B.Sum1) +
                     LaunchPad_B.Integrator_1) - LaunchPad_B.abc_d;
  ...
  LaunchPad_B.abc_q = 0.66666666666666663 * ((((-LaunchPad_B.Fcn_1) *
  ...
  LaunchPad_B.Sum9 = -(0.*(0.66666666666666663 * (((LaunchPad_UNCONNECTED *
    ...
    ((LaunchPad_B.Switch ? (3141.59265358979292*LaunchPad_X.LPF[0]) :
      ...
      LaunchPad_B.Integrator_2) - (0.785398163397448279*LaunchPad_B.abc_q));
  ...
  if (((!LaunchPad_X.Integrator_3_prevReset && LaunchPad_B.SW_2) ||
       (LaunchPad_X.Integrator_3_prevReset && !LaunchPad_B.SW_2))) {
    LaunchPad_X.Integrator_3_x = 0.;
  }
   ...
   */
  LaunchPad_B.Saturation1 = 0.5*LaunchPad_B.Fcn;
   ...
   */
  LaunchPad_B.Switch_1 = (HAL_getDigitalIn(3)) != 0.;
   ...
   */
  LaunchPad_B.LogicalOperator5 = ((fabs(LaunchPad_B.Fcn_2) >= 180.) || (fabs
    (LaunchPad_B.Fcn1_1) >= 180.) || (fabs(LaunchPad_B.Fcn2_1) >= 180.)) ||
    ((fabs(LaunchPad_B.Fcn_1) >= 20.) || (fabs(LaunchPad_B.Fcn1) >= 20.) ||
     (fabs(LaunchPad_B.Fcn2) >= 20.)) || (fabs(LaunchPad_B.Fcn) >= 250.);
  ...
  {
    if ((!LaunchPad_B.LogicalOperator5) && LaunchPad_B.SW_2 > 0) {
  ...
  HAL_setDigitalOut(6, LaunchPad_B.SW_2);
  ...
  LaunchPad_B.abc_q_1 = 0.66666666666666663 * ((((-LaunchPad_B.Fcn_2) *
    LaunchPad_B.Sin_3) + (LaunchPad_B.Fcn1_1 * ((0.5 * LaunchPad_B.Sin_3) +
    (0.866025403784438597 * LaunchPad_B.Cos_3)))) + (LaunchPad_B.Fcn2_1 * ((0.5 *
    LaunchPad_B.Sin_3) - (0.866025403784438597 * LaunchPad_B.Cos_3))));

  /* Integrator : 'LaunchPad/Controller/Phase-Locked Loop/PLL\nPI Regulator/Integrator' */
  if (((!LaunchPad_X.Integrator_4_prevReset && LaunchPad_B.SW_1) ||
       (LaunchPad_X.Integrator_4_prevReset && !LaunchPad_B.SW_1))) {
    LaunchPad_X.Integrator_4_x = 0.;
  }
  ...
  /* Gain : 'LaunchPad/Controller/Direct-Voltage Control/DVC\nPI Regulator/Gain2' */
  LaunchPad_B.Gain2_1 = -58.*LaunchPad_B.Sum1;
  ...
  LaunchPad_deriv[2] = 0.66666666666666663 * (((LaunchPad_B.Fcn_2 *
    LaunchPad_B.Cos_4) + (LaunchPad_B.Fcn1_1 * ((-0.5 * LaunchPad_B.Cos_4) +
    (0.866025403784438597 * LaunchPad_B.Sin_4)))) + (LaunchPad_B.Fcn2_1 * ((-0.5
  ...
  if ((LaunchPad_X.Integrator_1_x >= 20. && LaunchPad_B.Gain2_1 > 0) ||
      (LaunchPad_X.Integrator_1_x <= -20. && LaunchPad_B.Gain2_1 < 0)) {
    LaunchPad_deriv[6] = 0;
  } else {
  ...
  if ((LaunchPad_X.Integrator_2_x >= 200. && LaunchPad_B.Gain2_2 > 0) ||
    ...
    LaunchPad_deriv[4] = LaunchPad_B.Gain2_2;
  }
  ...
  if ((LaunchPad_X.Integrator_3_x >= 200. && LaunchPad_B.Gain2_3 > 0) ||
    ...
    LaunchPad_deriv[5] = LaunchPad_B.Gain2_3;
  }
  ...
  LaunchPad_X.Integrator_1_x += 5.00000000000000024e-05*LaunchPad_deriv[6];
  LaunchPad_X.Integrator_2_x += 5.00000000000000024e-05*LaunchPad_deriv[4];
