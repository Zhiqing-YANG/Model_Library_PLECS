...
typedef struct {
  ...
  double Integrator_1_x;               /* /LaunchPad/Controller/Direct-Voltage Control/DVC PI Regulator/Integrator */
  bool Integrator_1_prevReset;         /* /LaunchPad/Controller/Direct-Voltage Control/DVC PI Regulator/Integrator */
...
typedef struct {
  ...
  double Fcn;                          /* /LaunchPad/ADC Decode/Calibration V_dc/Fcn */
  double Sum1;                         /* /LaunchPad/Controller/Direct-Voltage Control/Sum1 */
  double SW_2;                         /* /LaunchPad/SW_2 */
  double Integrator_1;                 /* /LaunchPad/Controller/Direct-Voltage Control/DVC PI Regulator/Integrator */
  ...
  double Gain2_1;                      /* /LaunchPad/Controller/Direct-Voltage Control/DVC PI Regulator/Gain2 */
