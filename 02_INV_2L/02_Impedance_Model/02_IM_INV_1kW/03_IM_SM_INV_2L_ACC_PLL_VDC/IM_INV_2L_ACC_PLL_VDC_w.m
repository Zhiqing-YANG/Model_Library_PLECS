...
function [Z_inv_w, Y_inv_w, Z_pcc_w, Y_pcc_w, Z_g_w, Y_g_w] = IM_INV_2L_ACC_PLL_VDC_w(Grid,Inv,Ctrl,w)
...
% impedance
Z_inv_w = (I-Inv.OP.V_dc/2*G_PLL_m-G_dh*((G_VFF-G_ACC*G_damp)*G_PLL_v-(G_ACC+G_dec)*G_PLL_i-G_AD*(G_PLL_ic+Y_C)))\(G_dh*(G_ACC+G_dec)+Z_L1);
