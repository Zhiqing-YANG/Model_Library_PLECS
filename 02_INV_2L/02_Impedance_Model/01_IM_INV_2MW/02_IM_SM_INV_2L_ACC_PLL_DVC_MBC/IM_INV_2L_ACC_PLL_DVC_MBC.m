...
function [Z_inv, Y_inv, Z_pcc, Y_pcc, Z_g, Y_g] = IM_INV_2L_ACC_PLL_DVC_MBC(Grid,Inv,Ctrl,f_swp)
Z_inv.dd = [];
Z_inv.dq = [];
Z_inv.qd = [];
Z_inv.qq = [];
...
w_swp = 2*pi*f_swp;
for w = w_swp
    [Z_inv_w, Y_inv_w, Z_pcc_w, Y_pcc_w, Z_g_w, Y_g_w] = IM_INV_2L_ACC_PLL_DVC_MBC_w(Grid,Inv,Ctrl,w);
