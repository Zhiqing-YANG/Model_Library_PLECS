/*
 * Implementation file for: RCP_EXP_PLL_ACC_2L_GE_FSM/Circuit/LaunchPad
 * Generated with         : PLECS 4.5.3
 *                          TI2837xS 1.2.3
 * Generated on           : 10 Mar 2021 15:51:51
 */
...
const char * const LaunchPad_checksum =
  "f5bcccab1a42f9e24d2bf1d50c150ccb4be33d25";
...
void LaunchPad_step(void)
{
  ...
  LaunchPad_D_double[0] = ((fabs(LaunchPad_B.Fcn3) >= 120.) || (fabs
    (LaunchPad_B.Fcn4) >= 120.) || (fabs(LaunchPad_B.Fcn5) >= 120.)) || ((fabs
    (LaunchPad_B.Fcn) >= 8.) || (fabs(LaunchPad_B.Fcn1) >= 8.) || (fabs
    (LaunchPad_B.Fcn2) >= 8.));
   ...
   */
  LaunchPad_B.dq_a_1 = (0.800000000000000044 * LaunchPad_B.Cos_2) - (0. *
    LaunchPad_B.Sin_2);
   ...
   *  Constant : 'LaunchPad/Controller/OL/vc_q_ref'
   */
  LaunchPad_B.dq_b_1 = (0.800000000000000044 * ((-0.5 * LaunchPad_B.Cos_2) +
